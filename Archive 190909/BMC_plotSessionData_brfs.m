...
%   Version 1.1
%   Brock Carlson -- created 9/2/19
%   Taken from BMC_plotSessionData_rfori.m but commented out all photo
%   diode triggering becase the jnm triggering functions do not currently
%   work with the brfs files. This simply plots every stimulus onset and
%   does not break brfs down based on condition type.
%
%   This code also crashes because the ns6 files and the subsequent
%   filtered variables get too big.
%
