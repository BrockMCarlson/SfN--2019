...
npmkdir    = '/users/kaciedougherty/Documents/Code/fNPMK/'; 
nbanadir   = '/users/kaciedougherty/Documents/Code/nbanalysis/'; 

directory  = '/users/kaciedougherty/desktop/bootcamp/';
